...
class PretrainedConfig(object):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs) -> "PretrainedConfig":
        ...
        Args:
            pretrained_model_name_or_path (:obj:`string`):
                either:
                  - a string with the `shortcut name` of a pre-trained model configuration to load from cache_no_pretrained or
        ...
        Examples::
            ...
            config = BertConfig.from_pretrained('bert-base-uncased')    # Download configuration from S3 and cache_no_pretrained.
    ...
    def get_config_dict(
        ...
        try:
            # Load from URL or cache_no_pretrained if already cached
        ...
        if resolved_config_file == config_file:
            ...
            logger.info("loading configuration file {} from cache_no_pretrained at {}".format(config_file, resolved_config_file))
